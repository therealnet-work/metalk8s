...
def remove_etcd_node(ssh_config, k8s_client, node_name):
    ...
    etcd_member_id = get_etcd_member_id(k8s_client, ssh_config, node_name)
    ...
    if etcd_member_remove:
        etcd_member_list = etcdctl(
            k8s_client, ['member', 'list'], ssh_config, node_name
        )
...
def get_etcd_member_id(k8s_client, ssh_config, node_name):
